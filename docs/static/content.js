...
function ctor_structure()
{
  ...
  self.template = '<div id="body">' +
    '<div id="head" role="banner"><button onclick="structure.focusContent();" class="skip-nav" data-translate aria-label="data-content" data-content="Skip navigation"></button><div class="h-area"><div class="h-tabs"><ul><li style="display: none;"><button data-translate title="Shortcut: ALT+C" aria-label="Content tab" data-content="C?ontent" ></button></li><li><button data-translate title="Shortcut: ALT+N" aria-label="Index tab" data-content="Ë÷Òý"></button></li><li><button data-translate title="Shortcut: ALT+S" aria-label="Search tab" data-content="ËÑË÷"></button></li></ul></div><div class="h-tools sidebar"><ul><li class="sidebar"><button title="Hide or show the sidebar" data-translate aria-label="title">&#926;</button></li></ul></div><div class="h-tools online" style="width: 0px; visibility: hidden;"><ul><li class="home" style="display: none;"><a href="' + location.protocol + '//' + location.host + '" title="Go to the homepage" data-translate aria-label="title">&#916;</a></li><li class="language" style="display: none;"><button data-translate title="Change the language" data-translate aria-label="title" data-content="en"></button><ul class="dropdown languages selected"><li><a href="#" title="English" aria-label="title" data-content="en"></a></li><li><a href="#" title="Deutsch (German)" data-content="de" aria-label="title"></a></li><li><a href="#" title="&#xD55C;&#xAD6D;&#xC5B4 (Korean)" aria-label="title" data-content="ko"></a></li><li><a href="#" title="Portugu¨ºs (Portuguese)" data-content="pt" aria-label="title"></a></li><li><a href="#" title="&#x4E2D;&#x6587; (Chinese)" aria-label="title" data-content="zh"></a></li></ul></li><li class="version" style="display: none;"><button title="Change the version" data-translate aria-label="title" data-content="v1"></button><ul class="dropdown versions selected"><li><a href="#" title="AHK v1.1" aria-label="title" data-content="v1"></a></li><li><a href="#" title="AHK v2.0" aria-label="title" data-content="v2"></a></li></ul></li><li class="edit" style="display: none;"><a href="#" title="Edit this document on GitHub" data-translate=2 aria-label="title" data-content="E"></a></li></ul></div><div class="h-tools chm" style="width: 0px; visibility: hidden;"><ul><li class="back"><button title="Go back" data-translate=2 aria-label="title">&#9668;</button></li><li class="forward"><button title="Go forward" data-translate=2 aria-label="title">&#9658;</button></li><li class="zoom"><button title="Change the font size" data-translate=2 aria-label="title" data-content="Z"></button></li><li class="print"><button title="Print this document" data-translate=2 aria-label="title" data-content="P"></button></li><li class="browser"><a href="#" target="_blank" title="Open this document in the default browser (requires internet connection). Middle-click to copy the link address." data-translate aria-label="title">?</a></li></ul></div><div class="h-tools sidebar visible"><ul><li class="color"><button title="Use the dark or light theme" data-translate=2 aria-label="title" data-content="C"></button></li><li style="width: 0px; visibility: hidden;" class="settings"><button title="Open the help settings" data-translate=2 aria-label="title">&#1029;</button></li></ul></div></div></div>' +
    '<div id="main"><div id="left" role="navigation"><div class="tab toc"></div><div class="tab index"><div class="input"><input type="search" placeholder="..." data-translate=2 /></div><div class="select" style="display: none;"><select size="1" class="empty"><option value="-1" class="empty" selected data-translate>Filter</option><option value="0" data-translate>Directives</option><option value="1" data-translate>Built-in Variables</option><option value="2" data-translate>Built-in Functions</option><option value="3" data-translate>Control Flow Statements</option><option value="4" data-translate>Operators</option><option value="5" data-translate>Declarations</option><option value="6" data-translate>Commands</option><option value="7" data-translate>Sub-commands</option><option value="8" data-translate>Built-in Methods/Properties</option><option value="99" data-translate>Ahk2Exe Compiler</option></select></div><div class="list"></div></div><div class="tab search"><div class="input"><input type="search" placeholder="..." data-translate=2 /></div><div class="checkbox" style="display:none"><input type="checkbox" id="highlightWords"><label for="highlightWords" data-translate>Highlight keywords</label><div class="updown" title="Go to previous/next occurrence" data-translate aria-label="title"><div class="up"><div class="triangle-up"></div></div><div class="down"><div class="triangle-down"></div></div></div></div><div class="list"></div></div><div class="load"><div class="lds-dual-ring"></div></div>'+(isIE8?'':'<div class="quick" style="display: none;"><button class="header" title="Collapse or uncollapse the quick reference" data-translate aria-label="title"><div class="chevron"></div><span data-translate data-content="Quick reference"></span></button><div class="main"></div></div>')+'</div><div class="dragbar"></div><div id="right" tabIndex="-1">'+(isIE?'':'<div class="load"><div class="lds-dual-ring"></div></div>')+''+(isFrameCapable?'<iframe class="'+(isIE?'visible':'hidden')+'" frameBorder="0" id="frame" src="" role="main">':'<div class="area" role="main">');
    ...
    for (var i = 0; i < pres.length; i++) {
      ...
      if (!isSyntax && !isNoHighlight) {
        ...
        if (isIE8)
          ...
          dwn.setAttribute("data-content", '¡ý');
...
//document.querySelector("#left > div.quick > button").click();
//document.querySelector("#head > div > div.h-tabs > ul > li:nth-child(2) > button").click();